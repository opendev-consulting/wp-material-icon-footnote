/** Used icons definitions and imports */
...
/** Oficial logo swg path d  data (foot with an asterisc) */
...
/**
 * Generate a SVG image based on selected icon, color and given size.
 *
 * @return {SVG} Image to be renderes
 */
 ...
 *
 * @return {String} String with the encoded image data.
 */
